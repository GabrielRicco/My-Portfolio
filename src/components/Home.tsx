...
export function Home() {
    return (
        <div className="h-[500px] w-full flex items-center justify-between p-6 mt-7">
            <section className="flex flex-col h-5/6 justify-between p-8 mt-20">
                <div className="flex flex-col gap-3">
                    <h1 className="text-5xl">Hi Everyone! 👋</h1>
                    <h2 className="text-6xl">I'm <span className="text-blue-800">Gabriel Ricco</span></h2>
                </div>

                <div className="mt-20">
                    <h3 className="text-blue-600 font-bold text-6xl">Web Development</h3>
            ...
            <section>
                <Avatar>
                    <AvatarImage className="rounded-full w-72" src="https://github.com/gabrielricco.png" />
